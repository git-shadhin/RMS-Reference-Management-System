...
/**
 * Class used to work with reference of type Thesis
 * Contains necessary attributes and methods to work with Thesis object
 * Extends from Reference abstract class
 * @author Tin Huynh 
 * @version 2010.10.26
 */
public class Thesis extends Reference
{
    ...
    /**
     * Create a Thesis object that calls to method saving data to file
     ...
     */
    public Thesis(HashMap information, String noteText, String noteDate, BufferedWriter bw, BufferedReader br) throws IOException
    {
     ...
     * @param information collection of all information to be saved
     */
    public Thesis(HashMap information)
    {
       ...
       location = information.get("Location").toString();
    }
    
    /**
     * return Publisher of a Thesis
    ...
    /**
     * return Place of Publication of a Thesis
     * @return a String contains Place'state
     */
    ...
    public void setPlaceOfPublic(String newPlaceOfPublic)
    {
     ...
     /**
     * return Location of a Thesis
     * @return a String contains Location'state
     */
    ...
    /**
     * assign new value for Location
     * @param newPlaceOfPublic new Location value
     */
    ...
    /**
     * save the states of Thesis to text file
    ...
    public void saveToFile(int refNoInt, HashMap information, String noteText, String noteDate, BufferedWriter bw) throws IOException
    {
        int refNo = refNoInt;
        try {
            //continue to write Thesis specialized information to file after common information has been written by superclass
            bw.write("Publisher:" + information.get("Publisher").toString());
            bw.write("\r\n");
            bw.write("PlaceOfPublic:" + information.get("PlaceOfPublic").toString());
            bw.write("\r\n");
            bw.write("Location:" + information.get("Location").toString());
            bw.write("\r\n");
     ...
     * @param currentAuthor current author of editing Thesis
     * @param currentYear current year created of editing Thesis
     * @param currentTitle current title of editing Thesis
     * @param information editing information of Thesis
     * @param br used to read from file
            ...
            try {  
                ...
                while((line = br.readLine()) != null) {    
                   ...
                   if(line.equals("Title:".trim() + information.get("Title"))) {
                       ...
                       line = br.readLine();
                       pw.println("Location:"+ information.get("Location").toString());
                   }
                   else {
                       pw.println(line);
                   }
     ...
     * @exception FileNotFoundException if the file cannot be found
     */
    public Thesis readByNo(String thesisNo, String filePath) throws IOException
    {
       ...
       try {
            ...
            while((line = br.readLine()) != null) {
                ...
                if(line.replaceFirst("No:".trim(),"").equals(thesisNo)) {
                    ...
                    information.put("Location", br.readLine().replaceFirst("Location:".trim(),""));
                }
            }
       }
       catch(FileNotFoundException e) {}
       ...
       //create a new object of Thesis with information provided for attributes
       Thesis myThesis = new Thesis(information);
       return myThesis;
    }
    
    /**
     * read Thesis states from text file and instantiate the attributes
     * finally return the Thesis itself
     * @param br used to read from text file
     * @exception IOException if error occurs when input and output file
     * @exception FileNotFoundException if the file cannot be found
     */
    public Thesis readAThesis(BufferedReader br) throws IOException
    {
       String line;
       HashMap information =new HashMap();
       Note aNote = null;     
       ...
       try {     
             //read information from text file and create new Thesis object with these information
             information.put("Author", br.readLine().replaceFirst("Author:".trim(),""));
             information.put("Year", br.readLine().replaceFirst("Year:".trim(),""));
             information.put("Title", br.readLine().replaceFirst("Title:".trim(),""));
             information.put("Publisher", br.readLine().replaceFirst("Publisher:".trim(),""));
             information.put("PlaceOfPublic", br.readLine().replaceFirst("PlaceOfPublic:".trim(),""));
             information.put("Location", br.readLine().replaceFirst("Location:".trim(),""));
             myThesis = new Thesis(information);  
             line = br.readLine();
             ...
             while(!line.equals(("-----").trim())) {
                  ...
                  if(line.startsWith("NoteText:".trim())) {
                      ...
                      super.addNote(myThesis.myNotes, aNote);
                  }  
             }
       }
       catch(FileNotFoundException e) {}
    ...
    public String getBibliographicEntry()
    {
        ...
        if(!location.trim().equals("")) {
            bibLocation = location;
        }
        String  bibliographicEntry = super.getBibliographicEntry();
        bibliographicEntry += bibPublisher  + bibPlaceOfPublic  + bibLocation +".";  
        return bibliographicEntry;
    }
   
    /**
    * returns the states of Thesis's attributes 
    * @return a String represents current states of all Thesis's attributes
    */
    public String toString()
    {
       String myString; 
       myString = super.toString();
       myString += " Publisher: " +publisher+ " Place of Public: " +placeOfPublic+ " Location: " +location ;
       return myString; 
    }
